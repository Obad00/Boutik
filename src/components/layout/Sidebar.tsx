...
import { ShoppingCart, Package, Wallet, HandCoins, History, Settings, LogOut } from 'lucide-react';
...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-64 shrink-0 bg-[var(--color-primary)] text-white h-screen sticky top-0 px-4 py-6">
      <div className="flex items-center gap-2.5 px-2 mb-4">
        <div className="w-9 h-9 rounded-xl bg-white/10 flex items-center justify-center">
          <img src="/icons/boutik-icon-monochrome.svg" alt="" className="w-[18px] h-[18px]" />
        </div>
